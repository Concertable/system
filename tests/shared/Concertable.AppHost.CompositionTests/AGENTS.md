# Concertable.AppHost.CompositionTests — composition tests

**Composition-only: this tier builds the real production host graph without starting it or external
